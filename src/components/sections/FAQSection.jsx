...
const FAQ_DATA = [
    ...
    { id: 2, q: "Arbeiten Sie auch außerhalb von Lübeck?", a: "Ja, wir sind in ganz Schleswig-Holstein und Hamburg für Sie tätig. Sprechen Sie uns einfach an!" },
    { id: 3, q: "Sind Ihre Angebote wirklich Festpreise?", a: "Ja! Transparenz ist unser oberstes Gebot. Das Angebot, das Sie unterschreiben, ist der Preis, den Sie zahlen – solange sich Ihre Anforderungen während der Bauphase nicht ändern." },
    ...
    { id: 5, q: "Muss ich während der Renovierung aus der Wohnung ausziehen?", a: "Bei Teilrenovierungen (z.B. Malerarbeiten und Bodenbelag) können Sie in der Regel in der Wohnung bleiben. Bei einer Kernsanierung ist ein temporärer Auszug ratsam." },

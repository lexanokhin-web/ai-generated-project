                ...
                <div className="container mx-auto px-6 max-w-5xl relative z-10">
                    ...
                    <div className="hidden md:block overflow-hidden rounded-2xl shadow-xl bg-white">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {[
                                    { feature: "Schutz & Sauberkeit", us: <><CheckCircle className="inline w-5 h-5 mr-2" /> Kompletter Schutz & tägliche Reinigung</>, them: "✘ Baustaub & Risiko für Möbel" },
                                    { feature: "Materialqualität", us: <><CheckCircle className="inline w-5 h-5 mr-2" /> Nur Marken (Brillux, Knauf, etc.)</>, them: "✘ Billig-Baustoffe & No-Name" },
                                    { feature: "Präzisions-Finale", us: <><CheckCircle className="inline w-5 h-5 mr-2" /> Perfekte Kanten & Fugen</>, them: "✘ Unsaubere Ecken & Übergänge" },
                                    { feature: "Gewährleistung", us: <><CheckCircle className="inline w-5 h-5 mr-2" /> Volle Garantie auf alle Arbeiten</>, them: "✘ Schwierige Haftung bei Mängeln" }
                                ].map((row, idx) => (
                    ...
                    <div className="md:hidden space-y-6">
                        {[
                            ...
                            <div key={idx} className="bg-white rounded-2xl p-6 shadow-md border border-slate-100" data-aos="fade-up" data-aos-delay={idx * 100}>
                                <h4 className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-4">{row.feature}</h4>
                                <div className="space-y-4">
                                    <div className="p-4 rounded-xl bg-accent/5 border border-accent/10">
                                        <p className="text-accent text-xs font-bold uppercase mb-1">Winter & Usselmann</p>
                                        <div className="flex items-center text-slate-900 font-bold">
                                            <CheckCircle className="w-5 h-5 mr-2 text-accent shrink-0" />
                                            {row.us}
                                        </div>
                                    </div>
                                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 opacity-60">
                                        <p className="text-slate-400 text-xs font-bold uppercase mb-1">Einzelbeauftragung</p>
